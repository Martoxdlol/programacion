### Parte 4.6: nombres cambiados
def producto_vectorial(x1, y1, z1, x2, y2, z2): #Tambien podria ser producto_vectorial_r3 en caso de tener para varios r
...
### Parte 4.7: Funcion en una sola linea
def producto_vectorial(x1, y1, z1, x2, y2, z2): return y1*z2 - z1*y2, z1*x2 - x1*z2, x1*y2 - y1*x2

### Nota: para probar que las funciones andan comento una y pruebo la otra y viceversa, porque asi como esta la primer funcion no se utiliza
